...
class TestLootBag(unittest.TestCase):
    ...
    def test_list_child_toys(self):
        ...
        list_of_toys = bag.get_by_child("Trent")
        
        self.assertIs(type(list_of_toys), list)
        self.assertListEqual(list_of_toys, ["Google course", "Silly putty"])

    def test_can_be_delivered_to_child(self):
